...
def send_email_with_attachment_error(aname):
    ...
    receiver_email = ["enterpriseengineering@sagesure.com","donarose@eoxvantage.in","kristina.tomasetti@sagesure.com","claimsvendors@sagesure.com","abhishekgs@eoxvantage.com","pradeep@vantageagora.com","shriharim@eoxvantage.com","stefanie.lintner@sagesure.com","khavyaa@eoxvantage.com"]
...
def send_error_email(exp_desc):
    ...
    sender_email = "automation@eoxvantage.com"
    receiver_email = ["enterpriseengineering@sagesure.com","donarose@eoxvantage.in","kristina.tomasetti@sagesure.com","claimsvendors@sagesure.com","stefanie.lintner@sagesure.com","abhishekgs@eoxvantage.com","pradeep@vantageagora.com","shriharim@eoxvantage.com","khavyaa@eoxvantage.com"]
    password = "cpct bmuw eprv veen"
...
def send_text_email(subj):
    ...
    sender_email = "automation@eoxvantage.com"
    receiver_email = ["enterpriseengineering@sagesure.com","donarose@eoxvantage.in","kristina.tomasetti@sagesure.com","claimsvendors@sagesure.com","pradeep@vantageagora.com","shriharim@eoxvantage.com","stefanie.lintner@sagesure.com","abhishekgs@eoxvantage.com","khavyaa@eoxvantage.com"]
    password = "cpct bmuw eprv veen"
...
def send_text_email_invalid(subj, exp_desc):
    ...
    sender_email = "automation@eoxvantage.com"
    receiver_email = ["enterpriseengineering@sagesure.com","donarose@eoxvantage.in","kristina.tomasetti@sagesure.com","claimsvendors@sagesure.com","pradeep@vantageagora.com","shriharim@eoxvantage.com","stefanie.lintner@sagesure.com","abhishekgs@eoxvantage.com","khavyaa@eoxvantage.com"]
    # receiver_email = ["shriharim@eoxvantage.com","khavyaa@eoxvantage.com"]
    password = "cpct bmuw eprv veen"
    #receiver_email = ["shriharim@eoxvantage.com","abhishekgs@eoxvantage.com","pradeep@vantageagora.com"]
    # Create a multipart message and set headers
    message = MIMEMultipart()
